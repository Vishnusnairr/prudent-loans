...
export const AnalysedLoansRow = (props: LoanRowProps) => {
  const isMobile = useMediaQuery("(max-width:1200px)"); 

  if (isMobile) return <MobileLoanRow {...props} />;
  ...
  return (
    ...
    >
      ...
      <Typography textAlign="center" fontSize="14px" color="#0F172A" fontWeight={600}>
        {qualifiedIncome}
      </Typography>
